...
- 外部シースを設定する: [境界・外部領域の構成を選ぶ](https://nkzono99.github.io/BEACH/outer-plasma-models.html)。標準は`kinetic_1d`で、`unified_linear_response`はrough surface向けの高度な線形screeningです。
