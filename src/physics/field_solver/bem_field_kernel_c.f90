...
module bem_field_kernel_c
  ...
  use bem_coulomb_fmm_core, only: build_panel_plan, destroy_plan, destroy_state, eval_points, &
  ...
  use bem_panel_geometry, only: init_panel_geometry, panel_geometry_ok, panel_geometry_type
