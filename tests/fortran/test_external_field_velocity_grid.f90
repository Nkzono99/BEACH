...
program test_external_field_velocity_grid
  ...
  use bem_injection, only: compute_macro_particles_from_flux, sample_reservoir_velocity_grid_particles
  ...
  call assert_allclose_1d(v(:, 1), [0.0d0, 0.0d0, -2.0d0], 1.0d-12, 'sampled velocity mismatch')
  call test_end()
