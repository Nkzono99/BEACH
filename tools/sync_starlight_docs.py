...
PAGES = (
    ...
    Page("PhysicsRedesignCompletionAudit.md", "root", "physics-redesign-completion-audit", 125, "物理再設計phaseの実装・検証・scope監査。"),
    Page("PhysicsRedesignCompletionAudit.en.md", "en", "physics-redesign-completion-audit", 125, "Implementation, verification, and scope audit for the physics redesign."),
...
DOC_LINKS = {
    ...
    "PhysicsRedesignCompletionAudit": "physics-redesign-completion-audit",
    "Workflow": "workflow",
