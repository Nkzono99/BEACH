...
PAGES = (
    ...
    Page("agent-user-guide.md", "root", "agent-user-guide", 30, "Guide for AI agents operating BEACH simulations."),
    Page("agent-user-guide.en.md", "en", "agent-user-guide", 30, "Guide for AI agents operating BEACH simulations."),
    ...
    Page("Parameters.md", "root", "parameters", 50, "BEACH input parameter reference."),
    Page("Parameters.en.md", "en", "parameters", 50, "BEACH input parameter reference."),
    Page("PythonPostprocessAPI.md", "root", "python-postprocess-api", 60, "Python post-processing API reference."),
    Page("PythonPostprocessAPI.en.md", "en", "python-postprocess-api", 60, "Python post-processing API reference."),
    Page("Algorithms.md", "root", "algorithms", 70, "BEACH numerical algorithm guide."),
    Page("Algorithms.en.md", "en", "algorithms", 70, "BEACH numerical algorithm guide."),
    Page("FortranDependencyMap.md", "root", "fortran-dependency-map", 80, "Generated Fortran dependency map."),
    Page("FortranDependencyMap.en.md", "en", "fortran-dependency-map", 80, "Generated Fortran dependency map."),
)
