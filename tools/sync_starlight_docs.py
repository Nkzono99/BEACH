...
PAGES = (
    Page("index.md", "root", "index", 10, "BEACH documentation index."),
    Page("index.en.md", "en", "index", 10, "BEACH documentation index."),
    Page("Workflow.md", "root", "workflow", 20, "Recommended BEACH execution and development workflow."),
    Page("Workflow.en.md", "en", "workflow", 20, "Recommended BEACH execution and development workflow."),
    Page("Parameters.md", "root", "parameters", 30, "BEACH input parameter reference."),
    Page("Parameters.en.md", "en", "parameters", 30, "BEACH input parameter reference."),
    Page("Configuration.md", "root", "configuration", 40, "beachx config and high-level notation guide."),
    Page("Configuration.en.md", "en", "configuration", 40, "beachx config and high-level notation guide."),
    Page("PythonPostprocessAPI.md", "root", "python-postprocess-api", 50, "Python post-processing API reference."),
    Page("PythonPostprocessAPI.en.md", "en", "python-postprocess-api", 50, "Python post-processing API reference."),
    Page("Algorithms.md", "root", "algorithms", 60, "BEACH numerical algorithm overview."),
    Page("Algorithms.en.md", "en", "algorithms", 60, "BEACH numerical algorithm overview."),
    Page("FieldSolvers.md", "root", "field-solvers", 70, "BEACH field solvers and field boundary conditions."),
    Page("FieldSolvers.en.md", "en", "field-solvers", 70, "BEACH field solvers and field boundary conditions."),
    Page("ParticleChargeLoop.md", "root", "particle-charge-loop", 80, "Particle tracking and charge accumulation loop."),
    Page("ParticleChargeLoop.en.md", "en", "particle-charge-loop", 80, "Particle tracking and charge accumulation loop."),
    Page("FMMCore.md", "root", "fmm-core", 90, "Coulomb FMM core details."),
    Page("FMMCore.en.md", "en", "fmm-core", 90, "Coulomb FMM core details."),
    Page("BatchDurationStability.md", "root", "batch-duration-stability", 100, "batch_duration stability and steady value."),
    Page("BatchDurationStability.en.md", "en", "batch-duration-stability", 100, "batch_duration stability and steady value."),
    Page("FortranDependencyMap.md", "root", "fortran-dependency-map", 110, "Generated Fortran dependency map."),
    Page("FortranDependencyMap.en.md", "en", "fortran-dependency-map", 110, "Generated Fortran dependency map."),
    Page("agent-user-guide.md", "root", "agent-user-guide", 120, "Guide for AI agents operating BEACH simulations."),
    Page("agent-user-guide.en.md", "en", "agent-user-guide", 120, "Guide for AI agents operating BEACH simulations."),
)
