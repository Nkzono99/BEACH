...
| `src/physics/outer_plasma` | 6 | 20 |
| `src/physics/panel` | 5 | 13 |
| `src/physics/periodic_zero_mode` | 3 | 9 |
| `src/physics/sheath` | 1 | 2 |
| `src/runtime` | 7 | 34 |
| `src/runtime/coupling` | 10 | 34 |
| `src/runtime/simulator` | 7 | 50 |
...
| --- | --- | --- | --- | --- |
| `main` | `program` | `app/main.f90` | `bem_kinds`, `bem_version`, `bem_types`, `bem_mpi`, `bem_performance_profile`, `bem_simulator`, `bem_restart`, `bem_outer_event_queue`, `bem_outer_event_queue_io`, `bem_output_writer`, `bem_app_config`, `bem_mesh`, `bem_charge_ledger`, `bem_electrostatic_snapshot` | 設定読込・メッシュ生成・粒子初期化・シミュレーション実行・結果出力を順に行うCLIエントリーポイント。 |
...
| `bem_app_config_runtime` | `module` | `src/config/bem_app_config_runtime.f90` | `bem_kinds`, `bem_constants`, `bem_types`, `bem_mpi`, `bem_electrostatic_snapshot`, `bem_templates`, `bem_mesh`, `bem_panel_surface_sides`, `bem_collision`, `bem_importers`, `bem_injection`, `bem_particles`, `bem_outer_plasma_types`, `bem_external_boundary_contract`, `bem_app_config_types`, `bem_string_utils`, `bem_config_helpers` | `app_config` からメッシュ・粒子群を構築する実行時変換モジュール。 |
...
| `bem_mean_charge_integrator` | `module` | `src/physics/outer_plasma/bem_mean_charge_integrator.f90` | `bem_kinds`, `bem_constants` | 平面平均電荷を電流クロージャから陰的に時間発展させる数値コア。 |
...
| `bem_dynamic_k0_mean` | `module` | `src/runtime/coupling/bem_dynamic_k0_mean.f90` | `bem_kinds`, `bem_outer_plasma_types`, `bem_outer_plasma_kinetic`, `bem_mean_charge_integrator`, `bem_string_utils` | tracked粒子の局所depositと独立に、平面平均k=0電荷を陰的に進めるruntime adapter。 |
| `bem_dynamic_k0_zhao` | `module` | `src/runtime/coupling/bem_dynamic_k0_zhao.f90` | `bem_kinds`, `bem_constants`, `bem_dynamic_k0_mean`, `bem_outer_plasma_kinetic`, `bem_outer_plasma_types`, `bem_string_utils` | 実測界面エネルギー分布とZhao profileを結ぶ強光電子用mean-charge更新。 |
...
| `bem_mean_charge_transaction` | `module` | `src/runtime/coupling/bem_mean_charge_transaction.f90` | `bem_kinds` | 帰還粒子の発生元と着地点を区別して、平均電荷更新用の候補を構成する。 |
...
| `bem_external_step_driver` | `module` | `src/runtime/simulator/bem_external_step_driver.f90` | `bem_kinds`, `bem_types`, `bem_physics_config_types`, `bem_electrostatic_snapshot`, `bem_particle_stepper`, `bem_interface_types`, `bem_external_boundary_contract`, `bem_outer_plasma_interface` | local stepと外部輸送を、同一stepの残り時間が尽きるまで有限回接続する。 |
...
| `bem_simulator` | `module` | `src/runtime/simulator/bem_simulator.f90` | `bem_kinds`, `bem_constants`, `bem_types`, `bem_app_config`, `bem_app_config_runtime`, `bem_particles`, `bem_electrostatic_snapshot`, `bem_outer_coupler`, `bem_particle_stepper`, `bem_collision`, `bem_surface_models`, `bem_charge_ledger`, `bem_string_utils`, `bem_interface_types`, `bem_outer_event_queue`, `bem_external_boundary_contract`, `bem_external_step_driver`, `bem_outer_plasma_kinetic`, `bem_outer_plasma_kinetic_runtime`, `bem_dynamic_k0_mean`, `bem_dynamic_k0_zhao`, `bem_mean_charge_transaction`, `bem_zhao_steady_start`, `bem_outer_plasma_types`, `bem_simulator_workspace`, `bem_mpi` | 吸着(insulator)モデルのメインループを実行し、電荷堆積と統計更新を行うモジュール。 |
| `bem_simulator_workspace` | `module` | `src/runtime/simulator/bem_simulator_workspace.f90` | `bem_kinds`, `bem_interface_types`, `bem_outer_event_queue` | シミュレーション実行中に再利用するバッチ作業配列を管理する。 |
...
| `bem_simulator_loop` | `submodule` | `src/runtime/simulator/bem_simulator_loop.f90` | `bem_simulator`, `bem_periodic_zero_mode_plan`, `bem_performance_profile` | `bem_simulator` の主ループと粒子処理計算を実装する submodule。 |
...
- path: `app/main.f90`
- group: `app`
- 内部依存: `bem_kinds`, `bem_version`, `bem_types`, `bem_mpi`, `bem_performance_profile`, `bem_simulator`, `bem_restart`, `bem_outer_event_queue`, `bem_outer_event_queue_io`, `bem_output_writer`, `bem_app_config`, `bem_mesh`, `bem_charge_ledger`, `bem_electrostatic_snapshot`
...
- group: `src/config`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_types`, `bem_mpi`, `bem_electrostatic_snapshot`, `bem_templates`, `bem_mesh`, `bem_panel_surface_sides`, `bem_collision`, `bem_importers`, `bem_injection`, `bem_particles`, `bem_outer_plasma_types`, `bem_external_boundary_contract`, `bem_app_config_types`, `bem_string_utils`, `bem_config_helpers`
...
- group: `src/config`
- 内部依存: `bem_kinds`, `bem_types`, `bem_string_utils`, `bem_external_boundary_contract`
- external dependencies: `ieee_arithmetic`
...
- external dependencies: なし
- 概要: 外部境界に分散していた設定語彙を、実行時の単一契約へ正規化する。
...
- group: `src/physics`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_types`, `bem_field_solver`, `bem_physics_config_types`, `bem_string_utils`, `bem_periodic_zero_mode_plan`, `bem_periodic_zero_mode_eval`, `bem_coulomb_fmm_periodic_nonzero_reference`, `bem_outer_plasma_types`, `bem_outer_plasma_kinetic`, `bem_outer_plasma_zhao`, `bem_panel_geometry`, `bem_panel_kernel`, `bem_mpi`
- external dependencies: `iso_fortran_env`, `ieee_arithmetic`
...
### `bem_mean_charge_integrator`

- kind: `module`
- path: `src/physics/outer_plasma/bem_mean_charge_integrator.f90`
- group: `src/physics/outer_plasma`
- 内部依存: `bem_kinds`, `bem_constants`
- external dependencies: `ieee_arithmetic`
- 概要: 平面平均電荷を電流クロージャから陰的に時間発展させる数値コア。
...
- group: `src/physics/outer_plasma`
- 内部依存: `bem_kinds`, `bem_outer_plasma_types`, `bem_interface_types`, `bem_string_utils`
- external dependencies: `ieee_arithmetic`
...
- group: `src/physics/outer_plasma`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_outer_plasma_types`, `bem_outer_plasma_grid`, `bem_outer_plasma_zhao`, `bem_sheath_model_core`, `bem_string_utils`
- external dependencies: `ieee_arithmetic`
...
- group: `src/physics/outer_plasma`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_outer_plasma_types`, `bem_sheath_model_core`, `bem_string_utils`
- external dependencies: `ieee_arithmetic`
- 概要: Charge-driven quasi-steady Zhao outer-plasma closure.
...
- group: `src/runtime`
- 内部依存: `bem_kinds`, `bem_types`, `bem_app_config_types`, `bem_charge_ledger`, `bem_checkpoint_contract`, `bem_electrostatic_snapshot`, `bem_model_fingerprint`, `bem_outer_event_queue`, `bem_string_utils`, `bem_mpi`
- external dependencies: `ieee_arithmetic`
...
- kind: `module`
- path: `src/runtime/coupling/bem_dynamic_k0_mean.f90`
- group: `src/runtime/coupling`
- 内部依存: `bem_kinds`, `bem_outer_plasma_types`, `bem_outer_plasma_kinetic`, `bem_mean_charge_integrator`, `bem_string_utils`
- external dependencies: `ieee_arithmetic`
- 概要: tracked粒子の局所depositと独立に、平面平均k=0電荷を陰的に進めるruntime adapter。

### `bem_dynamic_k0_zhao`

- kind: `module`
- path: `src/runtime/coupling/bem_dynamic_k0_zhao.f90`
- group: `src/runtime/coupling`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_dynamic_k0_mean`, `bem_outer_plasma_kinetic`, `bem_outer_plasma_types`, `bem_string_utils`
- external dependencies: `ieee_arithmetic`
- 概要: 実測界面エネルギー分布とZhao profileを結ぶ強光電子用mean-charge更新。
...
### `bem_mean_charge_transaction`

- kind: `module`
- path: `src/runtime/coupling/bem_mean_charge_transaction.f90`
- group: `src/runtime/coupling`
- 内部依存: `bem_kinds`
- external dependencies: `ieee_arithmetic`
- 概要: 帰還粒子の発生元と着地点を区別して、平均電荷更新用の候補を構成する。
...
- group: `src/runtime/coupling`
- 内部依存: `bem_kinds`, `bem_filesystem`, `bem_mpi`, `bem_outer_event_queue`
- external dependencies: `ieee_arithmetic`
- 概要: Rank-local delayed outer-event queue checkpoint I/O.
...
- group: `src/runtime/coupling`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_types`, `bem_physics_config_types`, `bem_outer_plasma_kinetic`, `bem_outer_plasma_types`, `bem_string_utils`
- external dependencies: `ieee_arithmetic`
- 概要: Fresh run を Zhao 零電流定常枝の水平平均電荷へ初期化する。
...
- 内部依存: `bem_kinds`, `bem_types`, `bem_physics_config_types`, `bem_electrostatic_snapshot`, `bem_particle_stepper`, `bem_interface_types`, `bem_external_boundary_contract`, `bem_outer_plasma_interface`
- external dependencies: なし
- 概要: local stepと外部輸送を、同一stepの残り時間が尽きるまで有限回接続する。
...
- group: `src/runtime/simulator`
- 内部依存: `bem_kinds`, `bem_types`, `bem_electrostatic_snapshot`, `bem_pusher`, `bem_collision`, `bem_boundary`, `bem_interface_types`, `bem_external_boundary_contract`
- external dependencies: `ieee_arithmetic`
...
- group: `src/runtime/simulator`
- 内部依存: `bem_kinds`, `bem_constants`, `bem_types`, `bem_app_config`, `bem_app_config_runtime`, `bem_particles`, `bem_electrostatic_snapshot`, `bem_outer_coupler`, `bem_particle_stepper`, `bem_collision`, `bem_surface_models`, `bem_charge_ledger`, `bem_string_utils`, `bem_interface_types`, `bem_outer_event_queue`, `bem_external_boundary_contract`, `bem_external_step_driver`, `bem_outer_plasma_kinetic`, `bem_outer_plasma_kinetic_runtime`, `bem_dynamic_k0_mean`, `bem_dynamic_k0_zhao`, `bem_mean_charge_transaction`, `bem_zhao_steady_start`, `bem_outer_plasma_types`, `bem_simulator_workspace`, `bem_mpi`
- external dependencies: `iso_fortran_env`, `ieee_arithmetic`
...
- group: `src/runtime/simulator`
- 内部依存: `bem_kinds`, `bem_interface_types`, `bem_outer_event_queue`
- external dependencies: なし
...
- group: `src/runtime/simulator`
- parent: `bem_simulator`
- 内部依存: `bem_simulator`, `bem_periodic_zero_mode_plan`, `bem_performance_profile`
- external dependencies: `iso_fortran_env`
