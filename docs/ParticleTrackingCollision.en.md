...
A step ends in a next-time state, surface absorption, box escape, or an incomplete status. Reflect, periodic, and scalar-barrier
reflection keep the particle alive and advance the remaining time with the same update method.
