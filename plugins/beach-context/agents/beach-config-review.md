...
5. repo が読める場合は `docs/Configuration.md`, `docs/Tutorial.md`, `docs/FieldSolvers.md`,
   `docs/PeriodicElectrostatics.md`, `docs/OutputGuide.md`。
6. plugin 単体では `references/config_workflow.md`, `references/examples/tutorial_insulator.toml`,
   `references/examples/beach.toml`, `references/examples/periodic2_basic/beach.toml`。
...
- `beachx config init` の現行既定は x/y periodic、`field_solver="fmm"`、
  `field_periodic_image_layers=1`、far correctionなしの$3\times3$有限画像和として扱う。
