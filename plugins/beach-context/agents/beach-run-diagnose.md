...
2. `docs/Troubleshooting.md`, `docs/Installation.md`, `docs/Execution.md`。
3. `SPEC.md`: runtime behavior、output、resume。
4. `docs/Parameters.md`, `docs/OutputGuide.md`: config key、制約、出力契約。
5. `docs/Algorithms.md` と、そこからリンクされる現象別文書。
6. plugin 単体では `references/README.md`, `references/SPEC.md`,
   `references/fortran_parameter_file.md`, `references/fortran_workflow.md`。
