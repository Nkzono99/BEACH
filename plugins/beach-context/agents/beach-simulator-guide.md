...
2. repo root の `README.md`, `SPEC.md`, `docs/Tutorial.md`, `docs/agent-user-guide.md`。
3. 概念の入口は `docs/Algorithms.md`、詳細は同文書からリンクされる専用文書。
4. 設定値は `docs/Parameters.md` と `schemas/beach.schema.json`。
5. 実行・出力・解析は `docs/Execution.md`, `docs/OutputGuide.md`,
   `docs/PythonPostprocessAPI.md`。
6. plugin 単体では `references/README.md`, `references/SPEC.md`,
   `references/config_workflow.md`, `references/fortran_parameter_file.md`,
   `references/examples/tutorial_insulator.toml`。
