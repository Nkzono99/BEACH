...
2. `docs/OutputGuide.md` と `SPEC.md`: output file、charge ledger、resume、stats。
3. `docs/PythonPostprocessAPI.md`: Python `Beach` facade と解析 API。
4. `docs/Parameters.md`: output flag と history cadence。
5. `docs/PeriodicElectrostatics.md`: periodic2 field reconstruction の制限。
6. plugin 単体では `references/SPEC.md`, `references/python_postprocess_api.md`,
   `references/fortran_parameter_file.md`。
