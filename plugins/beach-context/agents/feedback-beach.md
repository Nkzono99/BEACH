...
2. `README.md`, `SPEC.md`, `docs/Parameters.md`, `docs/Troubleshooting.md`,
   `docs/Execution.md`, `docs/OutputGuide.md`, `docs/PythonPostprocessAPI.md`。
3. `docs/Algorithms.md` と現象別文書: numerical/physics 由来の挙動確認。
4. plugin 単体では `references/README.md`, `references/SPEC.md`,
   `references/fortran_parameter_file.md`, `references/python_postprocess_api.md`。
5. 既存 issue を確認できる場合は、重複や既解決の有無。
